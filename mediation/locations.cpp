...
/* the sales desk asks one question: how much is left at this location.
   the answer withholds the maintenance buffer on top of what is allocated,
   because capacity reserved for maintenance windows is not sellable. the
   arithmetic itself is the shared rule in unified-inventory-rules. */
